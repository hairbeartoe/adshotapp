...
schedule.every(2).minutes.do(run_threaded, query)  # this is to query the database every X minutes
schedule.every(2).minutes.do(run_threaded, capture_20)  # this will get screenshots every 20 minutes
schedule.every(4).minutes.do(run_threaded, capture_60)  # this will get screenshots every 60 minutes
schedule.every(6).minutes.do(run_threaded, capture_daily)  # this will get screenshots every 24 hours
